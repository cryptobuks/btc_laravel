                        ...
                        <div class="slider-content">
                            <div class="container">
                                <div class="slider-text text-center">
                                    <h3 class="slide-title"><span style="color:#ffff33;">Fund </span><span style="color:#ff9900;">Your dream </span><span style="color:#ffff33;">Project </span></h3>
                                    <h3 class="slide-title"><span style="color:#D3D3D3;">Today!</span></h2>
                                    <p><a class="slider btn btn-primary" href="#">Only $1.60 to spend</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="container">
                                    <div class="slider-text text-center">
                                        <h3 class="slide-title">
                                            <span style="color:#D3D3D3;">Daily</span>
                                            <span style="color:#ffff33;"> Cash </span>
                                            <span style="color:#D3D3D3;">Tripler!</span>
                                        </h2>
                        ...
                        <div class="row features-row">
                            ...
                            <div class="feature-box col-md-4 col-sm-12">
                                <span class="feature-icon">
                                    <img alt="download bitcoin" src="http://wellwishers.com/images/bit.png" />
                                </span>
                            ...
                            <div class="feature-box two col-md-4 col-sm-12">
                                <span class="feature-icon">
                                    <img alt="add bitcoins" src="http://wellwishers.com/images/lit.png" />
                                </span>
                                <div class="feature-box-content">
                            ...
                            <div class="feature-box three col-md-4 col-sm-12">
                                <span class="feature-icon">
                                    <img alt="buy and sell bitcoins" src="http://wellwisheers.com/images/eth.png" />
                                </span>
                                <div class="feature-box-content">
                        ...
                        <div class="row about-content">
                            ...
                            <div class="col-sm-12 col-md-5 col-lg-6 text-center">
                               <img alt="about us" class="img-responsive img-about-us"
                                    src="http://wellwishers.com/images/home.png" />
                            </div>
                            <!-- Image Ends -->
                            <!-- Content Starts -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-xs-12">
                                        <div class="feature text-center">
                                            ...
                                            <p>Complete level 5 of bitcoin matrix plus litecoin matrix, get iphone and Grocery,<br />
                                                valued at $150</p>
                                        </div>
                                    </div>
                                    <!-- Feature Ends -->
                                        ...
                                        <ul class="pricing-wrapper">
                                            ...
                                            <li class="is-visible" data-type="buy">
                                                ...
                                                <footer class="pricing-footer">
                                                    <a class="btn btn-primary" href="#">CASHOUT BITCOIN</a>
                                                </footer>
                                            </li>
                                    ...
                                    <li class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                        <ul class="pricing-wrapper">
                                            ...
                                            <li class="is-visible" data-type="buy">
                                                ...
                                                <footer class="pricing-footer"><a class="btn btn-primary" href="#">CASHOUT LITECOIN</a></footer>
                                            </li>
                                            ...
                                            <li class="is-hidden" data-type="sell">
                                                ...
                                                <footer class="pricing-footer">
                                                    <a class="btn btn-primary" href="#">VIEW PLAN</a></footer>
                                            </li>
                                    ...
                                    <li class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
                                        <ul class="pricing-wrapper">
                                            ...
                                            <li class="is-visible" data-type="buy">
                                                ...
                                                <footer class="pricing-footer">
                                                    <a class="btn btn-primary" href="#">CASHOUT ETHEREUM</a></footer>
                                            </li>
