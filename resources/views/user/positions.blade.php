...
@include('common.leftnav')
        ...
        <section class="about-page">
         ...
         <link href="../plugins/lity/prism.css" media="all" rel="stylesheet" type="text/css">
<link href="../plugins/lity/lity.css" rel="stylesheet"/>
...
<option selected value="">Select Matrix</option>
<option value="positions" selected>Bitcoin Matrix</option>
<option value="positions_lit_mat">Litecoin Matrix</option>
<option value="positions_eth_mat">Ethereum Matrix</option>
</select> 
                            </form>
                        ...
                        <div class="white">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_1">
                                ...
                                <tr>
                                    ...
                                    <td>B0.03900</td>
                                    <td>Cycled</td>
                                    <td><a href="http://wellwishersadvertisers.com/members/position_p"  data-lity>Genealogy</a></td>
                                </tr>
                                <!--<tr>-->
                                <!--    <td>&nbsp;</td>-->
...
<script src="../plugins/lity/jquery.js"></script>
<script src="../plugins/lity/lity.js"></script>

<script src="../plugins/lity/prism.js"></script>
