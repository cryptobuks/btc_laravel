...
<link href="{{ URL::to('plugins/lity/lity.css') }}" rel="stylesheet"/>
                        ...
                        <div align="left">
                            <form class="form_2">
                                <select size="1" name="jumpit" onchange="document.location.href=this.value"> 
									...
									<option value="viewmatrix" selected>Bitcoin Matrix</option>
									<option value="litecoinmatrix">Litecoin Matrix</option>
                        ...
                        <div class="white">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table_1">
                                ...
                                <tr>
                                    ...
                                    <td>B0.03900</td>
                                    <td>Cycled</td>
                                    <td><a href="{{ route('user.bcpopup') }}"  data-lity>Genealogy</a></td>
                                </tr>
                                <!--<tr>-->
                                <!--    <td>&nbsp;</td>-->
